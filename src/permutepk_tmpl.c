...
static void NAME(convert_data_pawn)(struct ThreadData *thread)
{
  ...
  pk_idx_state_init(&is, thread->begin, sq, perm_ii, stm);
  ...
  {
    pk_idx_state_to_sq(&is, sq, perm_ii);
